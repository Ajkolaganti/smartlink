...
function App() {
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/link/:id" element={<LinkRedirect />} />
        <Route path="/youtube/:videoId" element={<YouTubeRedirect />} />
        <Route path="/twitter/:tweetId" element={<TwitterRedirect />} />
        <Route path="/tiktok/:videoId" element={<TikTokRedirect />} />
        <Route
          path="/"
          element={
